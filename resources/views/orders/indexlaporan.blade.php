...
@section('title', __('Laporan Harian'))
@section('content-header', __('Laporan Harian'))
...
<div class="card">
    <div class="card-body">
        ...
        <a href="{{ route('generate.pdf', ['start_date' => $start_date, 'end_date' => $end_date]) }}" class="btn btn-primary">Cetak PDF</a>
