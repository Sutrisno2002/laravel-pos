...
<div class="card">
    <div class="card-body">
        ...
        <form action="{{ route('products.update', $product) }}" method="POST" enctype="multipart/form-data">
            ...
            <div class="form-group">
                <label for="price">{{ __('Expired') }}</label>
                <input type="date" name="exp" class="form-control @error('exp') is-invalid @enderror" id="exp"
                    placeholder="Expired" value="{{ old('price', $product->exp) }}">
                @error('exp')
                <span class="invalid-feedback" role="alert">
                    <strong>{{ $message }}</strong>
                </span>
